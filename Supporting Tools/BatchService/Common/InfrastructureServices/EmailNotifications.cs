...
namespace Adobe.OogwayBatch.Common
{
    ...
    public class EmailNotifications
    {
        ...
        private string defaultEmailID = System.Configuration.ConfigurationManager.AppSettings[CONST.SETTING_EMAIL_ID];
        private string defaultEmailName = System.Configuration.ConfigurationManager.AppSettings[CONST.SETTING_EMAIL_NAME];
        private string smtpServer = System.Configuration.ConfigurationManager.AppSettings[CONST.SETTING_SMTP_SERVER];
        private int smtpPort = Convert.ToInt16(System.Configuration.ConfigurationManager.AppSettings[CONST.SETTING_SMTP_PORT].ToString());
