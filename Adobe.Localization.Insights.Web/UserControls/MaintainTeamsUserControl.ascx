<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MaintainTeamsUserControl.ascx.cs"
    Inherits="Adobe.Localization.Insights.Web.UserControls.MaintainTeamsUserControl" %>
<asp:Panel ID="Panel" runat="server" Width="100%" Style="position: relative;">
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td align="left">
                <h1>
                    <asp:Label ID="LabelHeader" runat="server" Text="Maintain Teams" ForeColor="#DB512D"
                ...
                <asp:GridView ID="GridViewMasterDataDetails" runat="server" BackColor="White" BorderColor="#CCCCCC"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" Visible="False">
                            <ItemTemplate>
                                <asp:Label ID="LabelID" runat="server" Text='<%# Bind("VendorID") %>' Visible="true"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Team">
                            <ItemTemplate>
                                <asp:Label ID="LabelCode" runat="server" Text='<%# Bind("VendorCode") %>' Visible="true"></asp:Label>
                                <asp:TextBox ID="TextBoxCode" CssClass="TextBox" runat="server" Width="80%" Visible="false"></asp:TextBox>
                            </ItemTemplate>
                            <ControlStyle ForeColor="Navy" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Team Description">
                            <ItemTemplate>
                                <asp:Label ID="LabelDescription" runat="server" Text='<%# Bind("Vendor") %>' Visible="true"></asp:Label>
                                <asp:TextBox ID="TextBoxDescription" CssClass="TextBox" runat="server" Width="80%"
                                    Visible="false"></asp:TextBox>
                            </ItemTemplate>
                            <ControlStyle ForeColor="Navy" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Tester Type">
                            <ItemTemplate>
                                <asp:Label ID="LabelType" runat="server" Text='<%# Bind("VendorTypeID") %>' Visible="true"></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Location">
                            <ItemTemplate>
                                <asp:Label ID="LabelLocation" runat="server" Text='<%# Bind("VendorLocation") %>'
                                    Visible="true"></asp:Label>
                                <asp:TextBox ID="TextBoxLocation" CssClass="TextBox" runat="server" Width="80%" Visible="false"></asp:TextBox>
                            </ItemTemplate>
                            <ControlStyle ForeColor="Navy" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Contractor">
                            <ItemTemplate>
                                <asp:Label ID="LabelContractor" runat="server" Text='<%# Bind("isContractor") %>'
                                    Visible="true"></asp:Label>
                                <asp:CheckBox ID="CheckBoxContractor" runat="server" Width="80%" Visible="false">
                                </asp:CheckBox>
                            </ItemTemplate>
                            <ControlStyle ForeColor="Navy" />
                        </asp:TemplateField>
