            ...
            <td>
                ...
                <asp:Panel ID="PanelUpdateStatus" runat="server" Width="100%" Visible="false">
                    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>
                                <asp:Button ID="ButtonRefreshSID" runat="server" OnClick="ButtonRefreshSID_Click"
                                    Text="Generate / Refresh SID" Enabled="false" />
                                &nbsp;
                                ...
                                &nbsp;
                                <asp:TextBox ID="TextBoxBuildNo" runat="server" Text="BuildNbr" Visible="false" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
