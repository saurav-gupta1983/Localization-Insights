...
namespace Adobe.Localization.Insights.Web
{
    ...
    public partial class BlankSite : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (userID == "")
                SetControlsVisisbility(false);
            else
                SetControlsVisisbility(true);
        ...
        private void PopulateScreenLabels()
        {
            if ((DataTable)ViewState[WebConstants.TBL_SCREEN_LABELS] == null)
            {
                ...
                screenData.ScreenLabel = STR_SCREEN_LABEL_CRITERIA;
        ...
        private void SetMenuAndRoles(string userID)
        {
            ...
            //string filterCriteria = STR_PARENT_SCREEN_ID_FILTER + " = " + CONST_ZERO;
            //if (Session[WebConstants.SESSION_DATA_TREEVIEW_NODE_COLLECTION] != null)
            //{
        ...
        private void CreateTreeView(DataTable dtScreenAccess, TreeNode parentNode, string filterCriteria, int level)
        {
            ...
            foreach (DataRow dr in dvLevel.ToTable().Rows)
            {
                ...
                DataRow[] drScreenLabel = dtMenuLabels.Select(STR_SCREEN_ID_FILTER + " = " + screenID);
                ...
                string newFilterCriteria = STR_PARENT_SCREEN_ID_FILTER + " = " + screenID;
        ...
        private void SetControlsVisisbility(bool isLogged)
        {
        ...
        private void SetLeftPanelHeight(List<TreeNode> treeList, int height)
        {
            ...
            if (treeList != null)
                panelheight = (VAL_LEFT_PANEL_MAX_HEIGHT * treeList.Count) / VAL_LEFT_PANEL_MAX_COUNT;
            else
        ...
        private void SetScreenLabels(DataTable dtScreenLabels)
        {
            ...
            //HomeTextLinkButton.Text = COM.GetScreenLocalizedLabel(dtScreenLabels, HomeTextLinkButton.Text);
            //HelpTextLinkButton.Text = COM.GetScreenLocalizedLabel(dtScreenLabels, HelpTextLinkButton.Text);
            //HomeLinkButton.ToolTip = COM.GetScreenLocalizedLabel(dtScreenLabels, HomeLinkButton.ToolTip);
            //HelpLinkButton.ToolTip = COM.GetScreenLocalizedLabel(dtScreenLabels, HelpLinkButton.ToolTip);
            //LogOutTextLinkButton.Text = COM.GetScreenLocalizedLabel(dtScreenLabels, LogOutTextLinkButton.Text);
