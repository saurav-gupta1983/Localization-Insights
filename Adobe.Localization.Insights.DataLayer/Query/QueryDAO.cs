...
namespace Adobe.Localization.Insights.DataLayer.Query
{
    ...
    public static class QueryDAO
    {
        ...
        public static string GetUserDetails(DTO.Users userData)
        {
            ...
            query.Append(" ORDER BY U.FirstName ASC, U.LastName ASC, U.LoginID ASC");
        ...
        /// <param name="userName"></param>
        /// <returns></returns>
        public static string GetTeamFeedback(DTO.Users userData)
        {
            StringBuilder query = new StringBuilder(" Select Distinct TF.TeamFeedbackID, TF.IncidentDetails, TF.ProductVersionID, TF.VendorID, TF.Severity, TF.AddedBy, TF.AddedOn, TF.LoggedbyVendorID ");

            query.Append(" From (");
            query.Append(" Select FD.TeamFeedbackID, FD.IncidentDetails, FD.ProductVersionID, FD.VendorID, FD.Severity, FD.AddedBy, FD.AddedOn, U.VendorID as LoggedbyVendorID");
            query.Append(" From TeamFeedback FD");
            query.Append(" INNER JOIN Users U ");
            query.Append(" ON U.LoginID = FD.AddedBy ");

            if (userData.VendorID != "")
                query.Append(" AND FD.VendorID = " + userData.VendorID);

            if (userData.ProductVersionID != "")
                query.Append(" AND FD.ProductVersionID = " + userData.ProductVersionID);

            query.Append(" ) TF");
            query.Append(" INNER JOIN UserProducts UP ");
            query.Append(" ON TF.ProductVersionID = UP.ProductVersionID");
            ...
            query.Append(" Order by TF.AddedOn Desc");
        ...
        /// <param name="userName"></param>
        /// <returns></returns>
        public static string GetTeamFeedbackLogged(DTO.Users userData)
        {
            StringBuilder query = new StringBuilder(" Select Distinct TF.TeamFeedbackID, TF.IncidentDetails, TF.ProductVersionID, TF.VendorID, TF.Severity, TF.AddedBy, TF.AddedOn, TF.LoggedbyVendorID ");
            ...
            query.Append(" ON U.VendorID = V.VendorID");
            query.Append(" AND (V.isContractor = 0 OR (V.isContractor = 1 AND TF.VendorID = V.VendorID))");
        ...
        /// <param name="userData"></param>
        /// <returns></returns>
        public static string AddTeamFeedback(DTO.Users userData)
        {
            StringBuilder query = new StringBuilder("Insert Into TeamFeedback");

            query.Append("(IncidentDetails, Severity, ProductVersionID, VendorID, AddedOn, AddedBy)");
            query.Append("Values (");

            query.Append("'" + userData.IncidentDetails + "',");
            query.Append(userData.Severity + ",");
        ...
        /// <param name="transferData"></param>
        /// <returns></returns>
        public static string UpdateTeamFeedback(DTO.Users userData)
        {
            StringBuilder query = new StringBuilder("Update TeamFeedback SET ");

            query.Append(CheckForBlank("IncidentDetails", userData.IncidentDetails));
            query.Append(CheckForBlank("Severity", userData.Severity));
            query.Append(CheckForBlank("VendorID", userData.VendorID));

            if (userData.ProductVersionID == "")
                query.Append("ProductVersionID = null");
            else
                query.Append(CheckForBlank("ProductVersionID", userData.ProductVersionID));
        ...
        /// <param name="userData"></param>
        /// <returns></returns>
        public static string DeleteTeamFeedback(DTO.Users userData)
        {
            StringBuilder query = new StringBuilder("Delete From TeamFeedback ");

            query.Append(" WHERE TeamFeedbackID = '" + userData.TeamFeedbackID + "'");
        ...
        public static string GetUserProductRoles(DTO.Users userData)
        {
            ...
            if (userData.ProductVersionID != "")
                query.Append(" ON UP.ProductVersionID = " + userData.ProductVersionID);
        ...
        public static string GetUserProducts(DTO.Users userData)
        {
            ...
            {
                query.Append(" Select Distinct P.ProductID, P.Product, PV.ProductVersionID, PV.ProductVersion, PV.ProductCodeName, PV.IsActive, P.IsEnabled, PV.AddedOn");
        ...
        public static string GetUserScreenAccess(DTO.Users userData)
        {
            ...
            query.Append(" Select S.ScreenID, S.ScreenIdentifier, S.Sequence, S.IsProductType, S.IndexGroup, ");
        ...
        public static string GetProductVersion(DTO.Product productData)
        {
            ...
            if (productData.ProductYear != "-1")
            {
                query.Append(" AND pv.productYear = '" + productData.ProductYear + "'");
            }


            query.Append(" ORDER BY pv.IsActive DESC, pv.AddedOn DESC, pv.ProductVersion Desc");
        ...
        public static string GetProjectPhaseVendorUsers(DTO.ProjectPhases phasesData)
        {
            ...
            if (phasesData.ProductVersionID != "")
            ...
            query.Append(" INNER JOIN userproducts UP");
            query.Append(" ON UP.UserProjectRoleID = UPR.UserProjectRoleID");
            query.Append(" AND UP.ProductVersionID = pp.ProductVersionID");
        ...
        public static string GetVendorEfforts(DTO.WSRData wsrData)
        {
            ...
            query.Append(" INNER JOIN ProjectPhases pp");
            query.Append(" ON pl.ProjectPhaseID = pp.ProjectPhaseID");
            query.Append(" AND et.ProjectPhaseID = pp.ProjectPhaseID");
        ...
        public static string GetVendorDetails(DTO.Users userData)
        {
            ...
            query.Append(" Select Distinct V.VendorID, V.Vendor From Vendors V ");
            query.Append(" INNER JOIN Users U ");
        ...
        public static string GetProductWSRParameters(DTO.WSRData wsrParametersData)
        {
            ...
            if (wsrParametersData.ProductID == "" || (wsrParametersData.ProductID.Contains(",")))
            {
        ...
        public static string GetWSRData(DTO.WSRData dtoWSRData)
        {
            ...
            query.Append(" Select wsr.WSRDataID, wsr.WeekID, wsr.RedIssues, wsr.YellowIssues, wsr.GreenAccom, wsr.NextWeekDeliverables, wsr.FeaturesTested, wsr.Notes, wsr.ResourceCount, wsr.ResourceNames ");
            ...
            if (dtoWSRData.ProductID != "")
            {
                query.Append(" INNER JOIN ProductVersions PV");
                query.Append(" ON pp.ProductVersionID = pv.ProductVersionID");
                query.AppendFormat(" AND pv.ProductID IN ({0})", dtoWSRData.ProductID);
            }
        ...
        public static string GetWSRActualEfforts(DTO.WSRData dtoWSRData)
        {
            ...
            query.Append(" INNER JOIN (Select Distinct ProjectPhaseID, VendorID From ProjectLocales) pl");
            query.Append(" ON U.VendorID = pl.VendorID");
            query.Append(" AND et.ProjectPhaseID = pl.ProjectPhaseID");

            if (dtoWSRData.ProjectPhaseID != "")
            {
                query.Append(" AND pl.ProjectPhaseID = " + dtoWSRData.ProjectPhaseID);
            }
            else if (dtoWSRData.ProductVersionID != "" || dtoWSRData.TestingTypeID != "" || dtoWSRData.PhaseTypeID != "" || dtoWSRData.ProductYear != "-1")
            {
                query.Append(" INNER JOIN ProjectPhases pp");
                query.Append(" ON pl.ProjectPhaseID = pp.ProjectPhaseID");
                ...
                if (dtoWSRData.ProductYear != "-1")
                {
                    query.Append(" INNER JOIN ProductVersions pv");
                    query.Append(" ON pv.ProductVersionID = pp.ProductVersionID");
                    query.Append(" AND pv.ProductYear = '" + dtoWSRData.ProductYear + "'");
                }
            }
        ...
        /// <summary>
        /// GetWSRResourcesCount
        /// </summary>
        /// <param name="dtoWSRData"></param>
        /// <returns></returns>
        public static string GetWSRResourcesCount(DTO.WSRData dtoWSRData)
        {
            StringBuilder query = new StringBuilder();

            query.Append("Select wd.VendorID, pp.TestingTypeID, Min(wd.ResourceCount) MinResourceCount, Max(wd.ResourceCount) MaxResourceCount, Avg(wd.ResourceCount) AvgResourceCount");

            query.Append(" FROM WSRData wd");

            //if (dtoWSRData.ProductVersionID != "" || dtoWSRData.TestingTypeID != "" || dtoWSRData.PhaseTypeID != "" || dtoWSRData.ProductYear != "-1")
            //{
            query.Append(" INNER JOIN ProjectPhases pp");
            query.Append(" ON wd.ProjectPhaseID = pp.ProjectPhaseID");
            ...
            {
                if (dtoWSRData.WsrDataID != "")
                    query.Append(" AND wd.WSRDataID = " + dtoWSRData.WsrDataID);
                else
                    query.Append(" AND wd.WSRDataID = 0");
            }
            ...
            if (dtoWSRData.ReportingType != "")
                query.Append(" Group By wd.VendorID,pp.TestingTypeID");
        ...
        public static string UpdateWSRData(DTO.WSRData wsrData)
        {
            ...
            query.Append(" FeaturesTested = '" + wsrData.FeaturesTested.Replace("'", "''") + "',");
            query.Append(" Notes = '" + wsrData.Notes.Replace("'", "''") + "',");
            query.Append(" ResourceCount = " + wsrData.ResourceCount + ",");
            query.Append(" ResourceNames = '" + wsrData.ResourceNames.Replace("'", "''") + "',");
            query.Append(" UpdatedOn = SYSDATE(),");
            query.Append(" UpdatedBy = '" + wsrData.DataHeader.LoginID + "'");
        ...
        public static string AddWSRData(DTO.WSRData wsrData)
        {
            ...
            query.Append(" (ProjectPhaseID, VendorID, WeekID, RedIssues, YellowIssues, GreenAccom, NextWeekDeliverables, FeaturesTested, Notes, ResourceCount, ResourceNames, AddedOn, AddedBy)");
            query.Append(" Values (");
            ...
            query.Append(" '" + wsrData.FeaturesTested.Replace("'", "''") + "',");
            query.Append(" '" + wsrData.Notes.Replace("'", "''") + "',");
            query.Append(wsrData.ResourceCount + ",");
            query.Append(" '" + wsrData.ResourceNames.Replace("'", "''") + "',");
            query.Append(" SysDate(),");
        ...
        public static string GetProjectPhases(DTO.ProjectPhases projectPhaseData)
        {
            ...
            query.Append(" Select Distinct PPS.ProductVersionID, PPS.ProjectPhaseID, PPS.ProjectPhase, PPS.PhaseStartDate, PPS.PhaseEndDate, PPS.PhaseTypeID, PPS.ProductSprintID, PPS.TestingTypeID, PPS.AboutProjectPhase, PPS.StatusID, ");
        ...
        {
            StringBuilder query = new StringBuilder();
            query.Append(" Select pl.ProjectLocaleID, pl.ProductLocaleID, pl.ProjectPhaseID, pl.LocaleWeight, L.LocaleID, L.Locale, L.DisplayOrder, L.TestStudioKeyID, LT.TierID, V.VendorID, V.Vendor");
        ...
        {
            StringBuilder query = new StringBuilder();
            query.Append(" Select pp.ProjectPlatformID, pp.ProductPlatformID, pp.ProjectPhaseID, P.Platform, P.TestStudioKeyID");
        ...
        public static string GetPhaseExecutableTestCases(DTO.ProjectPhases projectPhaseData)
        {
            ...
            query.Append(" SELECT PCD.PhaseCoverageDetailID, Count(*) MatrixDataCount ");
            query.Append(" FROM PhaseCoverageDetails PCD");
            query.Append(" INNER JOIN projectlocalevsplatformdata PLPD");
            query.Append(" ON PCD.PhaseCoverageDetailID = PLPD.PhaseCoverageDetailID");

            if (projectPhaseData.PhaseCoverageDetailID != "")
                query.Append(" AND PCD.PhaseCoverageDetailID = " + projectPhaseData.PhaseCoverageDetailID);

            query.Append(" GROUP BY PCD.PhaseCoverageDetailID");
        ...
        /// <param name="projectPhaseData"></param>
        /// <returns></returns>
        public static string GetPhaseCoverageAllDetails(DTO.ProjectPhases projectPhaseData)
        {
            StringBuilder query = new StringBuilder();

            query.Append(" SELECT PCD.PhaseCoverageDetailID, PCD.PhaseCoverageDetails, PP.ProjectPhaseID, PP.ProjectPhase, PV.ProductVersionID, PV.ProductVersion, P.ProductID, P.Product ");
            query.Append(" FROM PhaseCoverageDetails PCD");
            query.Append(" INNER JOIN ProjectPhases PP");
            query.Append(" ON PP.ProjectPhaseID = PCD.ProjectPhaseID");
            query.Append(" INNER JOIN ProductVersions PV");
        ...
        public static string GetLocaleVsPlatformMatrixData(DTO.ProjectLocaleVsPlatformMatrix matrixData)
        {
            ...
            {
                query.Append(" SELECT PLPD.ProjectDataID, PLPD.ProjectPlatformID, PLPD.ProjectLocaleID, P.Platform, P.PlatformTypeID, L.Locale, ");
        ...
        /// <param name="projectPhaseData"></param>
        /// <returns></returns>
        public static string SaveProjectLocalesVsPlatformsMatrix(DTO.ProjectPhases projectPhaseData)
        {
            StringBuilder query = new StringBuilder();

            query.Append(" Update PhaseCoverageDetails SET ");
            query.Append(" TestCasesRepository = " + projectPhaseData.TestCasesRepositorySetting + ",");
            query.Append(" TestCasesDistribution =  " + projectPhaseData.TestCasesDistributeSetting + ",");
            query.Append(" AcrossLocalesandPlatforms = " + projectPhaseData.AcrossBlockSetting);
            query.Append(" Where PhaseCoverageDetailID = " + projectPhaseData.PhaseCoverageDetailID);
            ...
            {
                if (matrixData.ProjectDataID != "" && !matrixData.IsSelected)
                {
                    query.Append(" Delete From ProjectLocaleVsPlatformData ");
                    query.Append(" WHERE ProjectDataID = " + matrixData.ProjectDataID);
                    query.Append(" AND (TestCasesExecuted = 0 OR TestCasesExecuted Is Null)");
                    query.Append(" ; ");
                }
                else if (matrixData.ProjectDataID == "" && matrixData.IsSelected)
                {
                    query.Append(" Insert Into ProjectLocaleVsPlatformData(PhaseCoverageDetailID, ProjectLocaleID, ProjectPlatformID, ");
                    query.Append(" AddedOn, AddedBy) ");
                    query.Append(string.Format(" SELECT {0}, {1}, {2}, SysDate(), '{3}'", projectPhaseData.PhaseCoverageDetailID, matrixData.ProjectLocaleID, matrixData.ProjectPlatformID, projectPhaseData.DataHeader.LoginID));
                    query.Append(" ; ");
                }
            }
        ...
        /// <param name="projectPhaseData"></param>
        /// <returns></returns>
        public static string CopyLocalesVsPlatformsMatrix(DTO.ProjectPhases newProjectPhaseData, DTO.ProjectPhases oldProjectPhaseData)
        {
            StringBuilder query = new StringBuilder();

            query.Append(" INSERT INTO ProjectLocaleVsPlatformData (PhaseCoverageDetailID, ProjectLocaleID, ProjectPlatformID, ");
            query.Append(" AddedOn, AddedBy) ");
            query.Append(string.Format(" Select {0}, newPL.ProjectLocaleID, newPP.ProjectPlatformID, SysDate(), '{1}' ", newProjectPhaseData.PhaseCoverageDetailID, newProjectPhaseData.DataHeader.LoginID));
            query.Append(" From projectlocalevsplatformdata plpd ");
            query.Append(" INNER JOIN Projectlocales pl ");
            query.Append(" ON plpd.ProjectLocaleID = pl.ProjectLocaleID ");
            query.Append(" INNER JOIN Projectplatforms pp ");
            query.Append(" ON plpd.ProjectPlatformID = pp.ProjectPlatformID ");
            query.Append(string.Format(" AND plpd.PhaseCoverageDetailID = {0} ", oldProjectPhaseData.PhaseCoverageDetailID));
            query.Append(" INNER JOIN projectlocales newPL ");
            query.Append(" ON pl.ProductLocaleID = newPL.ProductLocaleID ");
            query.Append(string.Format(" AND newPL.ProjectPhaseID = {0} ", newProjectPhaseData.ProjectPhaseID));
            query.Append(" INNER JOIN Projectplatforms newPP ");
            query.Append(" ON pp.ProductPlatformID = newPP.ProductPlatformID ");
            query.Append(" AND newPP.ProjectPhaseID = newPL.ProjectPhaseID ");
        ...
        {
            StringBuilder query = new StringBuilder();
            query.Append(" Select PBD.ProjectBuildDetailID, PBD.ProjectBuildCode, PBD.ProjectBuild, PBD.IsReleaseBuild, PBD.GMBuildNo, PBD.GMDate, PBD.GMBuildPath");
            query.Append(" From ProjectBuildDetails PBD");
            query.Append(" WHERE PBD.ProductVersionID = " + productData.ProductVersionID);
            ...
            if (productData.IsReleaseBuild == "1")
                query.Append(" AND PBD.IsReleaseBuild = 1");
        ...
        public static string GetProjectBuildLocales(DTO.Product productData)
        {
            ...
            query.Append(" Select Distinct PBL.ProjectBuildLocaleID, PBL.ProjectBuildDetailID, PBD.ProjectBuildCode, PBD.ProjectBuild, PBL.ProductLocaleID, L.Locale");
            query.Append(" From ProjectBuildLocales PBL ");
            query.Append(" INNER JOIN ProjectBuildDetails PBD ");
            query.Append(" ON PBL.ProjectBuildDetailID = PBD.ProjectBuildDetailID");
            query.Append(" AND PBD.ProductVersionID = " + productData.ProductVersionID);
            ...
            if (productData.VendorID != "" || productData.ProjectPhaseID != "")
            {
                query.Append(" INNER JOIN ProjectLocales PRL ");
                query.Append(" ON PRL.ProductLocaleID = PL.ProductLocaleID");

                if (productData.VendorID != "")
                    query.Append(" AND PRL.VendorID = " + productData.VendorID);

                if (productData.ProjectPhaseID != "")
                    query.Append(" AND PRL.ProjectPhaseID = " + productData.ProjectPhaseID);
            }
        ...
        public static string GetScreenLocalizedLabels(DTO.Screens screenData)
        {
            ...
            {
                query.Append(" Select S.ScreenID, S.ScreenIdentifier, SLL.ScreenLocalizedLabelID, SL.ScreenLabelID, SL.ScreenLabel, SL.ScreenValue, LC.LabelCategoryID, LC.LabelCategory, ");
            ...
            {
                query.Append(" Select S.ScreenID, S.ScreenIdentifier, SL.ScreenLabelID, SL.ScreenLabel, SL.ScreenValue, LC.LabelCategoryID, LC.LabelCategory, ");
            ...
            query.Append(" INNER JOIN LabelCategories LC");
            query.Append(" ON SL.LabelCategoryID = LC.LabelCategoryID");
